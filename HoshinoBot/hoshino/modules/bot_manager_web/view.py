...
PASSWORD = hoshino.config.Sever_WebManagerPwd
# os.environ.get('BOT_MANAGER_WEB_PASSWORD') if os.environ.get(
#     'BOT_MANAGER_WEB_PASSWORD') else '987654321'

switcher = Blueprint('switcher', __name__, static_folder='statics',
                     static_url_path='/statics', url_prefix="/manage")
bot = nonebot.get_bot()
app = bot.server_app
