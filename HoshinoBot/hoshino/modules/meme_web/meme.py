...
public_address = config.Sever_Post  # 修改为服务器公网ip
meManagePwd = config.MeMeWeb_DeletFilePassWord  # 删除文件密码
loginUserName = config.MeMeWeb_UserName  # 登录账户
loginPassword = config.MeMeWeb_PassWord  # 登录密码
bot_name = config.NICKNAME[0]  # 机器人名字
group_name = config.MeMeWeb_Sites_Document_Title  # 公会名

sv = Service('meme_web', manage_priv=priv.SUPERUSER,
